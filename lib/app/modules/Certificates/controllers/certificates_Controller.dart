...
import '../../Certificate_View/Controller/certificate_view_Controller.dart';
  ...
  Future<void> certificates() async {
    ...
    if (certificateForm.currentState.validate()) {
      ...
      try {
        ...
        uploaded.value = false;
        await Get.toNamed(Routes.CertificatesView, arguments: 0);
        Get.find<CertificatesViewController>().getExperiences();
      } catch (e) {
        Get.showSnackbar(Ui.ErrorSnackBar(message: e.toString()));
      }
    }
